...
mod tests {
    ...
    fn test_proportional() {
        let mut controller = Pid::new(2.5f32, 0.0, 0.0, false, 0.25);
    ...
    #[test]
    fn test_derivative() {
        let mut controller = Pid::new(2.5f32, 0.0, 0.5, false, 0.25);
    ...
    #[test]
    fn test_integral() {
        let mut controller = Pid::new(2.5f32, 0.2, 0.0, false, 0.25);
    ...
    fn test_integral_ideal() {
        let mut controller = Pid::new(2.5f32, 0.2, 0.0, true, 0.25);
    ...
    fn test_integral_ideal_0kp() {
        let mut controller = Pid::new(0.0f32, 0.2, 5.0, true, 0.25);
